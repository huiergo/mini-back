export default {
  ...
  'pages.questionTable.questionNo': '试题编号',
  'pages.questionTable.title': '题干',
  'pages.questionTable.answer': '答案',
  'pages.questionTable.tags': '知识点',
  'pages.questionTable.subjects': '学科',
  'pages.questionTable.likeCount': '点赞量',
  'pages.questionTable.views': '浏览量',
  'pages.questionTable.checkStatus': '处理状态',
  'pages.questionTable.owner': '优化者',
  'pages.questionTable.updatedAt': '最后修改时间',
  'pages.questionTable.options': '操作',
